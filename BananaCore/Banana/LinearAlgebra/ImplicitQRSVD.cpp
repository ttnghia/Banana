...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
template void svd<Real>(const Mat2x2<Real>& A, const Mat2x2<Real>& U, const Vec2<Real>& Sigma, const Mat2x2<Real>& V, Real tol);
template Int  svd<Real>(const Mat3x3<Real>& A, Mat3x3<Real>& U, Vec3<Real>& sigma, Mat3x3<Real>& V, Real tol);
template void polar<Real>(const Mat2x2<Real>& A, const Mat2x2<Real>& R, const Mat2x2<Real>& S_Sym);
