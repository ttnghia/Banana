...
template<class RealType>
RealType fraction_inside(RealType phi_bl, RealType phi_br, RealType phi_tl, RealType phi_tr)
{
    ...
    else if(inside_count == 3)
    {
        ...
        RealType side0 = 1 - fraction_inside(list[0], list[3]);
        RealType side1 = 1 - fraction_inside(list[0], list[1]);
    ...
    else if(inside_count == 2)
    {
        ...
        {
            RealType side_left  = fraction_inside(list[0], list[3]);
            RealType side_right = fraction_inside(list[1], list[2]);
        ...
        else   //matching signs are diagonally opposite
        {
            ...
            RealType middle_point = 0.25f * (list[0] + list[1] + list[2] + list[3]);
            ...
            if(middle_point < 0)
            {
                ...
                RealType side1 = 1 - fraction_inside(list[0], list[3]);
                RealType side3 = 1 - fraction_inside(list[2], list[3]);

                area += 0.5f * side1 * side3;

                //second triangle (top right)
                RealType side2 = 1 - fraction_inside(list[2], list[1]);
                RealType side0 = 1 - fraction_inside(list[0], list[1]);
            ...
            else
            {
                ...
                RealType side0 = fraction_inside(list[0], list[1]);
                RealType side1 = fraction_inside(list[0], list[3]);
                area += 0.5f * side0 * side1;

                //second triangle (top right)
                RealType side2 = fraction_inside(list[2], list[1]);
                RealType side3 = fraction_inside(list[2], list[3]);
    ...
    else if(inside_count == 1)
    {
        ...
        RealType side0 = fraction_inside(list[0], list[3]);
        RealType side1 = fraction_inside(list[0], list[1]);
