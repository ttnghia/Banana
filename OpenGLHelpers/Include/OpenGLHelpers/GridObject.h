...
{
public:
    GridObject(int sizeX = 1, int sizeY = 1,
               float scaleTexX = 1.0, float scaleTexY = 1.0) :
        m_SizeX(0), m_SizeY(0)
    {
        generateGrid(sizeX, sizeY, scaleTexX, scaleTexY);
    }

    void generateGrid(int sizeX, int sizeY, float scaleTexX = 1.0, float scaleTexY = 1.0)
    {
        clearData();
