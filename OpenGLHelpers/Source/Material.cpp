...
void Material::uploadDiffuseColor()
{
    ...
    m_UniformBuffer.uploadData(glm::value_ptr(m_MaterialData.diffuse), sizeof(glm::vec4), sizeof(glm::vec4));
}
...
void Material::uploadSpecularColor()
{
    ...
    m_UniformBuffer.uploadData(glm::value_ptr(m_MaterialData.specular), 2 * sizeof(glm::vec4), sizeof(glm::vec4));
}
...
void Material::uploadShininess()
{
    ...
    m_UniformBuffer.uploadData(&m_MaterialData.shininess, 3 * sizeof(glm::vec4), sizeof(GLfloat));
}
