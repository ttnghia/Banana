...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
ShaderProgram* ShaderProgram::getObjUniformColorShader()
{
    const GLchar* vertexShader =
        "// This is the shader statically generated by ShaderProgram class\n"
        "#version 410 core\n"
    ...
    ShaderProgram* shader = new ShaderProgram(std::string("ObjUniformColorShader"));
    shader->addVertexShader(vertexShader);
    shader->addFragmentShader(fragmentShader);
    shader->link();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
ShaderProgram* ShaderProgram::getObjTextureShader()
{
    const GLchar* vertexShader =
        "// This is the shader statically generated by ShaderProgram class\n"
        "#version 410 core\n"
    ...
    ShaderProgram* shader = new ShaderProgram(std::string("ObjTextureShader"));
    shader->addVertexShader(vertexShader);
    shader->addFragmentShader(fragmentShader);
    shader->link();
...
ShaderProgram* ShaderProgram::ShaderProgram::getSkyBoxShader()
{
    ...
    const GLchar* fragmentShader =
        ...
        "{\n"
        "   vec3 viewDir = normalize(f_viewDir);\n"
        "   outColor = texture(texSampler, viewDir);\n"
