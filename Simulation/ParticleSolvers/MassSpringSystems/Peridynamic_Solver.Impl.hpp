...
void PeridynamicsSolver::setupDataIO()
{
    ...
    if(m_GlobalParams.savingData("connected_component_label")) {
        ...
        m_ParticleDataIO->addParticleAttribute<UInt16>("connected_component_label", ParticleSerialization::TypeVectorChar, 1);
    }
