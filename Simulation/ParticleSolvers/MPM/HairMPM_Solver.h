...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static String                                 solverName() { return String("HairMPM_") + std::to_string(N) + String("DSolver"); }
    static SharedPtr<ParticleSolver<N, RealType>> createSolver() { return std::make_shared<HairMPM_Solver<N, RealType>>(); }
