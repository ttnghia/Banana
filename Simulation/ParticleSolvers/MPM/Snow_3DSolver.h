...
struct SimulationParameters_Snow3D : public SimulationParameters
{
    ...
    virtual void makeReady() override
    {
        ...
        movingBMin = domainBMin + Vec3r(cellSize * ParticleSolverDefaultParameters::NExpandCells);
        movingBMax = domainBMax - Vec3r(cellSize * ParticleSolverDefaultParameters::NExpandCells);
