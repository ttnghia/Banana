...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    static bool                                    registerSolver(const String& solverName, const String& solverDescription, PtrCreateMethod funcCreate);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
template<Int N, class RealType>
bool ParticleSolverFactory<N, RealType >::registerSolver(const String& solverName, const String& solverDescription, PtrCreateMethod funcCreate)
{
...
{
protected:
    static inline bool s_bRegistered = ParticleSolverFactory<Solver::solverDimension(), Solver::SolverRealType>::registerSolver(Solver::getSolverName(),
                                                                                                                                Solver::getCreateMethod());
};
