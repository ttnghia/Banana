...
{
public:
    PCISPHSolver(std::shared_ptr<ParameterManager>& params, SPHParameters* SPHParams) :
        SPHSolver(params, SPHParams),
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#include <ParticleSolvers/SPH/PCISPHSolver_Impl.hpp>
