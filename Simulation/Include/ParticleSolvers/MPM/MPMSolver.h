...
public:
    ...
    Vec_Vec3<RealType>& getParticles()  { return m_SimData.particles; }
    Vec_Vec3<RealType>& getVelocity()  { return m_SimData.velocity; }

private:
    std::shared_ptr<MPMParameters> m_SimParams;
    MPMData<RealType>              m_SimData;
};

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#include <ParticleSolvers/MPM/MPMSolver_Impl.hpp>
