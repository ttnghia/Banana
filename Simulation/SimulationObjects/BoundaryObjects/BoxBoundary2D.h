...
{
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
class BoxBoundary2D : public BoundaryObject<2, Real>
{
public:
    BoxBoundary2D() : BoundaryObject<2, Real>("Box") { }
    BoxBoundary2D(const Vec2r& bMin, const Vec2r& bMax) : BoundaryObject<2, Real>("Box") { setBox(bMin, bMax); }
